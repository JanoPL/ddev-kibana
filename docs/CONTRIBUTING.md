...
1. Clone the repo
   ...
   ```sh
   git clone https://github.com/janopl/janopl\ddev-kibana
   ```
...
3. Run the tests and see if everything is OK, it will take some time.

## Issues and feature requests

You've found a bug in the source code, a mistake in the documentation or maybe you'd like a new feature? You can help us by [submitting an issue on GitHub](https://github.com/janopl/ddev-kibana/issues). Before you create an issue, make sure to search the issue archive -- your issue may have already been addressed!
...
1. Search our repository for open or closed
   [Pull Requests](https://github.com/janopl/ddev-kibana/pulls)
